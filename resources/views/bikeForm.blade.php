...
<body class="bg-gray-100">
    ...
    <div class="flex items-center justify-center min-h-screen pb-10">
        <div class="w-full max-w-2xl p-8 bg-white rounded-lg shadow-lg">
            <h1 class="text-3xl font-bold mb-8 text-center text-gray-900">Add New Bike for Sale</h1>
            <form action="{{ route('storeNewBike') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                @csrf
                <div>
